...
export default function About() {
  return (
    <section id="about" className="py-20 bg-gray-950 flex flex-col items-center relative overflow-hidden">
      ...
      <motion.div
        ...
        className="flex flex-col md:flex-row items-center max-w-4xl mx-auto px-4 gap-10"
      >
        <img
          src="/Profile.jpg"
          alt="Profile"
          className="w-44 h-44 rounded-full object-cover border-4 border-indigo-600 shadow-lg mb-6 md:mb-0"
        />
