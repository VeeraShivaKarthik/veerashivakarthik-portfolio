...
export default function Contact() {
  return (
    <section id="contact" className="py-20 bg-gray-950 flex justify-center items-center">
      <motion.div
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.7 }}
        className="w-full max-w-lg bg-gray-900 rounded-xl shadow-lg p-8"
      >
        <h2 className="text-3xl font-bold mb-8 text-indigo-400 text-center">Contact</h2>
        <div className="flex flex-col gap-6 items-center text-lg">
          <motion.div className="flex items-center gap-3" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.1 }}>
            <motion.span whileHover={{ scale: 1.3, rotate: -10 }} className="inline-block w-8 h-8 bg-indigo-600 text-white rounded-full flex items-center justify-center text-xl cursor-pointer">📞</motion.span>
          ...
          <motion.div className="flex items-center gap-3" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2 }}>
            <motion.span whileHover={{ scale: 1.3, rotate: 10 }} className="inline-block w-8 h-8 bg-indigo-600 text-white rounded-full flex items-center justify-center text-xl cursor-pointer">✉️</motion.span>
          ...
          <motion.div className="flex items-center gap-3" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.3 }}>
            <motion.span whileHover={{ scale: 1.3, rotate: 5 }} className="inline-block w-8 h-8 bg-indigo-600 text-white rounded-full flex items-center justify-center text-xl cursor-pointer">🔗</motion.span>
